...
function findIntersection(arr1: any[], arr2: any[]) {
    ...
    const set2: Set<any> = new Set(arr2);
    return arr1.filter(item => set2.has(item));
}

// Usage examples
const example1: any[] = findIntersection([1, 2, 3, 4], [3, 4, 5, 6]);
console.log('Example 1:', example1); // [3, 4]

const example2: any[] = findIntersection(['apple', 'banana', 'orange'], ['banana', 'kiwi', 'orange', 'pear']);
console.log('Example 2:', example2); // ['banana', 'orange']

const example3: any[] = findIntersection([1, 2, 2, 3], [2, 2, 3, 4]);
console.log('Example 3:', example3); // [2, 2, 3]

// Example with empty array result
const example4: any[] = findIntersection([1, 2, 3], [4, 5, 6]);
...
function advancedIntersection(arr1: any[], arr2: any[], options: IntersectionOptions = {}): any[] {
    ...
    const set2: Set<any> = new Set(arr2);
    let result: any[] = arr1.filter(item => set2.has(item));
...
const advExample: any[] = advancedIntersection([1, 2, 2, 3, 3], [2, 2, 3, 4], { removeDuplicates: true });
